...
export const EDIT_STYLE_CONFIGS: Record<EditStyle, EditStyleConfig> = {
  ...
  podcast:     { silence: "light",      cutFillers: false, cutRepeats: true,  deadSpaceMin: null, interruptEvery: 7, zoomScale: 1.08, emphasisZoomThreshold: 5,   highlightZoomThreshold: 7,   moveHookToFront: true,  hookTextOverlay: true,  ctaText: null },
